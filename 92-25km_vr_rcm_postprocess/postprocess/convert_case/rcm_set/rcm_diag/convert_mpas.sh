...
path2output=/raid62/yycheng/MPAS/TPEMIP_92-25km/${modetype}_postprocess/${modetype}_model/92-25km_${modetype}_${year}/out_convert_latlon/${targetfile}/

for IFILE in `ls ${path2input}/*.nc`;do
# IFILE=path2input+'/history.2003-04-01_00.00.00.nc'
       echo ${IFILE}" ok"
        # ${NCKS} -h -A ${FNMOD} ${IFILE}/raid62/yycheng/convert_case/convert_mpas/raid62/yycheng/convert_case/convert_mpasconvert_mpas/convert_mpas \
/raid62/yycheng/convert_case/convert_mpas/convert_mpas \
/raid62/yycheng/MPAS/TPEMIP_92-25km/${modetype}/92-25km_${modetype}_${year}/china_rcm.init.nc \
${IFILE} 
