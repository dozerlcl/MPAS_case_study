...
target_folder="hum_theta_daily_vi"
target_file="hum_theta"
modetype="RCM"
...
92-25km_${modetype}_${year}/vertical_interp/${target_folder}
mkdir -p $path_out
...
#----
{
python ./vertical_interp.py $IFILE $path_out/${target_file}_`basename ${IFILE}`
