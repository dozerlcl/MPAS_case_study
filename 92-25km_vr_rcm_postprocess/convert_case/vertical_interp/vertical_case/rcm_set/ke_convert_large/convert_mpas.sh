...
/92-25km_${modetype}_${year}/out_convert_latlon_large/${target_file}
...
/raid62/yycheng/MPAS/TPEMIP_92-25km/${modetype}/92-25km_${modetype}_${year}/china_rcm.grid.nc \
${IFILE}
