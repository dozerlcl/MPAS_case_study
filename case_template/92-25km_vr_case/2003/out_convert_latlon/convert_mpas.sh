...
cd /m2data2/yycheng/yycheng/MPAS/92-25km_VR/out_convert_latlon
path2input=/raid52/yycheng/MPAS/92-25km_VR/out/history
for IFILE in `ls ${path2input}/*.nc`;do
# IFILE=path2input+'/history.2003-04-01_00.00.00.nc'
       echo ${IFILE}" ok"
        # ${NCKS} -h -A ${FNMOD} ${IFILE}
/m2data2/yycheng/MPAS/TOOLS/convert_mpas_mpi/convert_mpas \
/raid52/yycheng/MPAS/92-25km_VR/ea.init.nc \
${IFILE} \
echo 'finish ${IFILE}'
